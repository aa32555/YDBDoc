...
If the total length of the subscripts specified to $QUERY() exceeds 1,048,576 , $QUERY() returns a `YDB-E-MAXSTRLEN <https://docs.yottadb.com/MessageRecovery/errors.html#maxstrlen>`_ error.
